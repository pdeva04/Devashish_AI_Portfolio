  ...
  return (
    <section className="py-12 md:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div ref={cardsRef as any} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div 
          ref={statsRef as any} 
          className="mt-12 md:mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center"
        >
          {[
            ...
            >
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold hero-text mb-2">
                {stat.number}
              </div>
